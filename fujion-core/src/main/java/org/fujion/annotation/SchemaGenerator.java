...
public class SchemaGenerator {
    ...
    public static void main(String... args) throws Exception {
        ...
        options.addOption(option);
        option = new Option("f", true, "Fujion Framework version");
        options.addOption(option);
        ...
        fujionVersion = fujionVersion == null ? null : new Version(fujionVersion).toString(VersionPart.MINOR);
        String xml = new SchemaGenerator(packages, fujionVersion, cmd.hasOption("v")).toString();
    ...
    public SchemaGenerator(String[] packages, String fujionVersion, boolean v1_0_compatible) throws Exception {
